...
<head>
    ...
    <meta name="description" content="RBeverything is your trusted technology partner for IT consulting, web development, AI implementation, system architecture, and tech training.">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,300;0,14..32,400;0,14..32,500;0,14..32,600;0,14..32,700;0,14..32,800;0,14..32,900&family=JetBrains+Mono:wght@400;700&display=swap" rel="stylesheet">
...
<div id="rb-mobile-menu" class="rb-mobile-menu" role="dialog" aria-modal="true" aria-label="Mobile navigation">
    <nav style="display:flex;flex-direction:column;gap:0.25rem;">
        <a href="#products" style="font-size:1.8rem;font-weight:800;letter-spacing:-0.03em;color:#F1F5F9;text-decoration:none;padding:0.5rem 0;border-bottom:1px solid rgba(255,255,255,0.06);" data-i18n="nav.products">Products</a>
        <a href="#services"  style="font-size:1.8rem;font-weight:800;letter-spacing:-0.03em;color:#F1F5F9;text-decoration:none;padding:0.5rem 0;border-bottom:1px solid rgba(255,255,255,0.06);" data-i18n="nav.services">Services</a>
        <a href="#blog"      style="font-size:1.8rem;font-weight:800;letter-spacing:-0.03em;color:#F1F5F9;text-decoration:none;padding:0.5rem 0;border-bottom:1px solid rgba(255,255,255,0.06);" data-i18n="nav.blog">Blog</a>
        <a href="#about"     style="font-size:1.8rem;font-weight:800;letter-spacing:-0.03em;color:#F1F5F9;text-decoration:none;padding:0.5rem 0;border-bottom:1px solid rgba(255,255,255,0.06);" data-i18n="nav.about">About Us</a>
    </nav>
...
<section class="rb-hero" aria-label="Hero">
    <div id="rb-hero-content" style="position:relative;z-index:1;width:100%;max-width:56rem;margin:0 auto;text-align:center;">
        ...
        {{-- Typewriter line --}}
        <div class="rb-hero-typewriter-line" data-reveal data-reveal-delay="2" aria-live="polite" aria-atomic="true">
            <span id="typewriter-target" class="rb-gradient-text"></span><span class="rb-cursor" aria-hidden="true"></span>
        </div>

        {{-- Subtitle --}}
        <p class="rb-hero-subtitle" data-reveal data-reveal-delay="3" data-i18n="hero.subtitle">
            Your trusted technology partner. We craft smarter systems, bolder digital products, and AI-powered solutions — all under one roof.
        </p>
...
<section id="products" aria-label="Products">
    <div class="rb-section">
        <div style="margin-bottom:4rem;" data-reveal>
            ...
            <p class="rb-section-desc" data-i18n="products.desc">Powerful standalone micro-tools engineered for developers and teams.</p>
        </div>
            ...
            <article class="rb-card" data-reveal data-reveal-delay="1" style="padding:2rem;">
                <div class="rb-card-content">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.25rem;">
                        <span class="rb-tag tag-violet" data-i18n="products.liveness.tag">AI · Computer Vision</span>
                        <span style="font-size:0.68rem;font-family:'JetBrains Mono',monospace;color:#334155;">v1.1</span>
                    </div>
                    <h3 style="font-size:1.3rem;font-weight:800;letter-spacing:-0.02em;margin-bottom:0.5rem;color:#F1F5F9;" data-i18n="products.liveness.name">Passive Liveness Detection</h3>
                    <p style="font-size:0.875rem;color:#64748B;line-height:1.7;margin-bottom:1.5rem;" data-i18n="products.liveness.desc">
                        Frictionless identity verification. Anti-spoofing biometric detection that distinguishes real faces from photos, videos, and 3D masks — without user interaction.
                    </p>
                    ...
                    <div class="rb-liveness-demo">
                        ...
                        <div class="rb-face-oval" aria-hidden="true">
                            ...
                            <div class="rb-face-ring"></div>
                            {{-- Face silhouette SVG --}}
                            <svg width="32" height="36" viewBox="0 0 40 46" fill="none" stroke="rgba(167,139,250,0.5)" stroke-width="1.5" stroke-linecap="round">
                    ...
                    <a href="#contact" style="display:inline-flex;align-items:center;gap:0.4rem;font-size:0.85rem;font-weight:600;color:#A78BFA;text-decoration:none;" data-i18n="products.liveness.cta">
                        Learn More
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                    </a>
                </div>
            ...
            <article class="rb-card" data-reveal data-reveal-delay="2" style="padding:2rem;">
                <div class="rb-card-content">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.25rem;">
                        ...
                        <span style="font-size:0.68rem;font-family:'JetBrains Mono',monospace;color:#334155;">v2.4</span>
                    </div>
                    <h3 style="font-size:1.3rem;font-weight:800;letter-spacing:-0.02em;margin-bottom:0.5rem;color:#F1F5F9;" data-i18n="products.base64.name">Base64 Suite</h3>
                    <p style="font-size:0.875rem;color:#64748B;line-height:1.7;margin-bottom:1.5rem;" data-i18n="products.base64.desc">
                        Encode, decode, and validate Base64 strings in real-time with support for URL-safe variants.
                    </p>
                    ...
                    <div style="display:flex;flex-direction:column;gap:0.6rem;margin-bottom:1.5rem;">
                        ...
                        <textarea
                            id="rb-b64-input"
                            class="rb-base64-input"
                            rows="3"
                            data-i18n="products.base64.placeholder"
                            placeholder="Type something to encode..."
                            aria-label="Text to encode in Base64"
                        ></textarea>
                    ...
                    <a href="https://tools.rbeverything.com/base64" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.4rem;font-size:0.85rem;font-weight:600;color:#38BDF8;text-decoration:none;" data-i18n="products.base64.cta">
                        Open Tool
            ...
            <article class="rb-card" data-reveal data-reveal-delay="3" style="padding:2rem;">
                <div class="rb-card-content">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.25rem;">
                        ...
                        <span style="font-size:0.68rem;font-family:'JetBrains Mono',monospace;color:#334155;">v3.0</span>
                    </div>
                    <h3 style="font-size:1.3rem;font-weight:800;letter-spacing:-0.02em;margin-bottom:0.5rem;color:#F1F5F9;" data-i18n="products.portfolio.name">Portfolio Platform</h3>
                    <p style="font-size:0.875rem;color:#64748B;line-height:1.7;margin-bottom:1.5rem;" data-i18n="products.portfolio.desc">
                        Every user gets a personalised /@slug page to showcase skills, experience, and achievements.
                    </p>
                    ...
                    <div class="rb-demo-window" style="margin-bottom:1.5rem;">
                        ...
                        <div class="rb-demo-code"><span style="color:#38BDF8">const</span> <span style="color:#34D399">user</span> = {
  slug: <span style="color:#818CF8">'@rafly'</span>,
  role: <span style="color:#818CF8">'Premium'</span>,
  skills: [<span style="color:#FB7185">'Laravel'</span>, <span style="color:#FB7185">'AI'</span>]
};</div>
                    </div>

                    <a href="/client-area/register" style="display:inline-flex;align-items:center;gap:0.4rem;font-size:0.85rem;font-weight:600;color:#34D399;text-decoration:none;" data-i18n="products.portfolio.cta">
                        Build Your Page
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                    </a>
                </div>
...
<section id="services" aria-label="Services and Workflow">
    <div class="rb-section">
        ...
        {{-- Section header --}}
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:3rem;align-items:end;margin-bottom:3.5rem;" data-reveal>
            <div>
        ...
        <div class="rb-services-grid" style="margin-bottom:5rem;">
            ...
            <div class="rb-service-tile" data-reveal data-reveal-delay="{{ $i + 1 }}">
                ...
                <h3 style="font-size:0.95rem;font-weight:700;margin-bottom:0.35rem;color:#F1F5F9;" data-i18n="services.items.{{ $service['key'] }}.title">
                    {{ $service['key'] }}
                </h3>
                <p style="font-size:0.8rem;color:#64748B;line-height:1.65;" data-i18n="services.items.{{ $service['key'] }}.desc">
        ...
        <div data-reveal>
            ...
            <h2 class="rb-section-title" style="font-size:clamp(1.6rem,3.5vw,2.8rem);" data-i18n="workflow.title">From idea to launch in four steps</h2>
        </div>
        ...
        <div class="rb-workflow-grid">
            ...
            <div class="rb-workflow-step" data-reveal data-reveal-delay="{{ $idx + 1 }}">
                ...
                <div class="rb-workflow-icon">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#38BDF8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        {!! $workflowIcons[$step] ?? '' !!}
                    </svg>
                </div>
                <span class="rb-workflow-name" data-i18n="workflow.steps.{{ $step }}.name">{{ ucfirst($step) }}</span>
        ...
        <div style="margin-top:5rem;" data-reveal>
            <p style="font-size:0.68rem;letter-spacing:0.14em;text-transform:uppercase;color:#334155;font-weight:600;text-align:center;margin-bottom:1.5rem;" data-i18n="services.techstrip_label">Technologies we work with</p>
...
<section id="blog" aria-label="Blog">
    <div class="rb-section">
        ...
        <div style="display:flex;align-items:flex-end;justify-content:space-between;flex-wrap:wrap;gap:1.5rem;margin-bottom:3rem;" data-reveal>
            <div>
                <span class="rb-section-label" data-i18n="blog.label">Blog</span>
                <h2 class="rb-section-title" style="margin-bottom:0;" data-i18n="blog.title">Latest articles</h2>
            </div>
        ...
        <div style="margin-top:2.5rem;text-align:center;" data-reveal data-reveal-delay="2">
            <a href="#" style="font-size:0.875rem;font-weight:600;color:#64748B;text-decoration:none;border-bottom:1px solid #1E293B;padding-bottom:2px;transition:color 0.3s,border-color 0.3s;" data-i18n="blog.view_all">View all articles →</a>
        </div>
...
<section id="about" aria-label="About">
    <div class="rb-section" style="max-width:52rem;text-align:center;">
        ...
        <p style="font-size:1.05rem;color:#64748B;line-height:1.8;margin:1.5rem auto 3rem;max-width:40rem;" data-reveal data-reveal-delay="2" data-i18n="about.desc">
            RBeverything is a technology studio passionate about building products that are not only powerful but delightful to use.
        </p>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:2rem;border:1px solid rgba(255,255,255,0.06);border-radius:1.25rem;padding:2.5rem;background:rgba(255,255,255,0.02);" data-reveal data-reveal-delay="3">
            <div>
                <div style="font-size:2.4rem;font-weight:900;letter-spacing:-0.04em;line-height:1;background:linear-gradient(135deg,#38BDF8,#818CF8);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">10+</div>
                <div style="font-size:0.78rem;color:#475569;margin-top:0.4rem;font-weight:500;" data-i18n="about.stat_products">Products shipped</div>
            </div>
            <div style="border-left:1px solid rgba(255,255,255,0.06);border-right:1px solid rgba(255,255,255,0.06);">
                <div style="font-size:2.4rem;font-weight:900;letter-spacing:-0.04em;line-height:1;background:linear-gradient(135deg,#38BDF8,#818CF8);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">3+</div>
                <div style="font-size:0.78rem;color:#475569;margin-top:0.4rem;font-weight:500;" data-i18n="about.stat_years">Years of experience</div>
            </div>
            <div>
                <div style="font-size:2.4rem;font-weight:900;letter-spacing:-0.04em;line-height:1;background:linear-gradient(135deg,#38BDF8,#818CF8);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">∞</div>
                <div style="font-size:0.78rem;color:#475569;margin-top:0.4rem;font-weight:500;" data-i18n="about.stat_quality">Commitment to quality</div>
            </div>
        </div>
    </div>
</section>
...
<footer class="rb-footer" id="contact" aria-label="Footer">
    <div class="rb-footer-grid">
        ...
        <div>
            ...
            <p class="rb-footer-slogan" data-i18n="footer.slogan">Everything you need. Smarter systems, bolder results — delivered with precision and care.</p>
            <div style="display:flex;gap:0.6rem;margin-top:1.5rem;">
                @foreach($pageData['footer']['socials'] as $social)
                <a href="{{ $social['href'] }}" target="_blank" rel="noopener" class="rb-social-link" aria-label="{{ $social['name'] }}">
        ...
        <div>
            ...
            <a href="{{ $link['href'] }}" class="rb-footer-link"
               @if(isset($link['label_key'])) data-i18n="{{ $link['label_key'] }}" @endif>
        ...
        <div>
            ...
            <a href="mailto:{{ $pageData['footer']['email'] }}" class="rb-footer-link" style="display:flex;align-items:center;gap:0.5rem;">
            ...
            <p style="font-size:0.78rem;color:#334155;line-height:1.65;margin-top:1.25rem;" data-i18n="footer.based">
                Based in Indonesia. Serving clients worldwide.
            </p>
            <a href="mailto:{{ $pageData['footer']['email'] }}" class="rb-btn-hero" style="margin-top:1.5rem;display:inline-flex;font-size:0.85rem;padding:0.6rem 1.3rem;" data-i18n="footer.start_project">
                Start a Project
            </a>
        </div>
