...
<head>
    ...
    <title><?php echo e($article->getTranslation('title', $locale, true)); ?> — RBeverything</title>
    <meta name="description" content="<?php echo e(Str::limit(strip_tags($article->getTranslation('content', $locale, true)), 160)); ?>">
    <link rel="canonical" href="<?php echo e(url()->current()); ?>">
    
    <meta property="og:title" content="<?php echo e($article->getTranslation('title', $locale, true)); ?> — RBeverything">
    <meta property="og:description" content="<?php echo e(Str::limit(strip_tags($article->getTranslation('content', $locale, true)), 160)); ?>">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->thumbnail): ?>
        <meta property="og:image" content="<?php echo e(asset('storage/' . $article->thumbnail)); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?php echo e($article->getTranslation('title', $locale, true)); ?> — RBeverything">
    <meta name="twitter:description" content="<?php echo e(Str::limit(strip_tags($article->getTranslation('content', $locale, true)), 160)); ?>">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->thumbnail): ?>
        <meta name="twitter:image" content="<?php echo e(asset('storage/' . $article->thumbnail)); ?>">
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Article",
      "headline": "<?php echo e(addslashes($article->getTranslation('title', $locale, true))); ?>",
      "image": [
        "<?php echo e($article->thumbnail ? asset('storage/' . $article->thumbnail) : ''); ?>"
      ],
      "datePublished": "<?php echo e($article->published_at ? $article->published_at->toIso8601String() : ''); ?>",
      "author": [{
          "@type": "Person",
          "name": "RBeverything"
      }]
...
<body>
        ...
        <section aria-label="Article Header">
            <div style="max-width:56rem;margin:0 auto;padding:0 1.5rem 3rem;">
                ...
                <nav style="margin-bottom:2.5rem;font-size:0.8rem;color:var(--color-muted);" aria-label="Breadcrumb">
                    ...
                    <span style="margin:0 0.5rem;opacity:0.4;">/</span>
                    <span style="color:var(--color-text);"><?php echo e(Str::limit($article->getTranslation('title', $locale, true), 40)); ?></span>
                </nav>
                ...
                <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;flex-wrap:wrap;">
                    ...
                    <span style="font-size:0.8rem;color:var(--color-muted);">
                        <?php echo e(ceil(str_word_count(strip_tags($article->getTranslation('content', $locale, true))) / 200)); ?> min read
                    </span>
                </div>
                ...
                <h1 style="font-size:clamp(2rem,5vw,3.25rem);font-weight:900;letter-spacing:-0.03em;line-height:1.1;color:var(--color-text);margin-bottom:1.5rem;">
                    <?php echo e($article->getTranslation('title', $locale, true)); ?>
                ...
                <div style="max-width:56rem;margin:0 auto;padding:0 1.5rem 3rem;">
                    <div style="border-radius:1.25rem;overflow:hidden;border:1px solid rgba(255,255,255,0.06);box-shadow:0 20px 60px rgba(0,0,0,0.5);">
                        <img src="<?php echo e(asset('storage/' . $article->thumbnail)); ?>"
                             alt="<?php echo e($article->getTranslation('title', $locale, true)); ?>"
        ...
        <section aria-label="Article Content">
            <div style="max-width:56rem;margin:0 auto;padding:0 1.5rem 6rem;">
                <div class="prose prose-invert prose-lg"
                    ...
                    <?php echo $article->getTranslation('content', $locale, true); ?>
                ...
                <div style="max-width:80rem;margin:0 auto;padding:4rem 1.5rem;">
                    ...
                    <div style="display:grid;gap:1.5rem;grid-template-columns:repeat(1,1fr);" class="related-grid">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            ...
                            ?>
                            <a href="<?php echo e(route('blog.show', $rel->slug)); ?>" class="rb-card"
                                ...
                                <div class="rb-card-content" style="display:flex;flex-direction:column;height:100%;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($rel->thumbnail): ?>
                                        <div style="height:160px;overflow:hidden;">
                                            <img src="<?php echo e(asset('storage/' . $rel->thumbnail)); ?>"
                                                 alt="<?php echo e($relTitle); ?>"
                                    ...
                                    <div style="padding:1.25rem;display:flex;flex-direction:column;gap:0.5rem;flex:1;">
                                        ...
                                        <h3 style="font-size:1rem;font-weight:700;line-height:1.4;color:var(--color-text);margin:0;"><?php echo e($relTitle); ?></h3>
                                        <p style="font-size:0.8rem;color:var(--color-muted);line-height:1.6;flex:1;margin:0;"><?php echo e(Str::limit(strip_tags($relContent), 100)); ?></p>
                                        <span style="font-size:0.7rem;color:var(--color-muted);font-family:var(--font-mono);margin-top:0.5rem;">
                                            <?php echo e($rel->published_at?->format('M d, Y') ?? ''); ?>
    ...
    <footer class="rb-footer" aria-label="Footer">
        ...
        <div class="rb-footer-bottom">
            <span>© <?php echo e(date('Y')); ?> RBeverything. All rights reserved.</span>
