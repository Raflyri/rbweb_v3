...
return [
    ...
    'settings'      => [
        ...
        /*
         * Profile for Article bodies.
         *
         * Must cover everything the Filament RichEditor toolbar can emit —
         * attachFiles, blockquote, bold, bulletList, codeBlock, h2, h3,
         * italic, link, orderedList, strike, table, underline — otherwise
         * purifying an existing article would quietly destroy its formatting.
         */
        'article' => [
            'HTML.Doctype'          => 'HTML 4.01 Transitional',
